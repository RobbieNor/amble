...
import logging
logger = logging.getLogger('amble_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by AmbleWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('AmbleWindow')
        new_object = builder.get_object("amble_window")
    ...
    def finish_initializing(self, builder):
        ...
        self.settings = Gio.Settings("net.launchpad.amble")
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for amble."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for amble."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the AmbleWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the AmbleWindow is closed."""
