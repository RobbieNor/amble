...
class PreferencesLectureNoteCreatorDialog(PreferencesDialog):
    ...
    def finish_initializing(self, builder): # pylint: disable=E1002
        ...
        self.bkploc_same_button = self.builder.get_object("bkploc_same_button")

        self.options_list = [self.save_xoj_button, self.save_pdf_button, self.gen_html_button, self.bkp_xoj_button, self.bkp_pdf_button, self.bkp_html_button, self.compress_button, self.html_index_button, self.seperate_types_button, self.bkploc_same_button]
    ...
    def on_saveprefs_clicked(self, widget):
        ...
        #Test that directories given are valid here? Remember that bkp can be alowed to be NONE if bkploc_same ticked.
